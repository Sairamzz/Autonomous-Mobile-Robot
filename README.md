...
The robot used in this project was custom-designed to support onboard sensors, computation, and locomotion requirements. All CAD models and SolidWorks design files can be found in ```Robot Design``` folder in the repo.
